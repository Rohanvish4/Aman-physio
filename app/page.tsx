          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <a href="tel:+918948451008" className="btn-primary flex items-center justify-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                  Call Now
                </a>
                <a href="https://wa.me/918948451008?text=Hello%20Urmila%20PhysioCare,%20I%20would%20like%20to%20book%20an%20appointment." target="_blank" rel="noopener noreferrer" className="btn-secondary flex items-center justify-center gap-2">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-semibold text-text mb-2">Expert Team</h3>
              <p className="text-sm text-text-light leading-relaxed">
                Led by Dr. Aman Mishra, our dedicated team brings years of clinical experience in orthopedic, neurological, and pediatric rehabilitation.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {[
              ...
              },
              {
                ...
                desc: 'Advanced pain relief techniques including muscle cupping and dry needle therapy.',
                icon: (
              ...
              },
              {
                ...
                desc: 'Specialized interventions designed to boost child mobility, strength, and overall well-being.',
                icon: (
      ...
      <section className="py-20 md:py-24 bg-primary">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            ...
            <a href="tel:+918948451008" className="px-7 py-3.5 border border-white/30 text-white font-semibold rounded-lg hover:bg-white/10 transition-colors inline-flex items-center justify-center gap-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
              Call Us
            </a>
          </div>
